...
$mail_to_email = 'ignosiagroup@gmail.com'; // your email
...
try {
	...
	$mail->Username = 'ignosiagroup@gmail.com'; // SMTP username
	$mail->Password = 'mail1220'; // SMTP password
	...
	$mail->Send(header('Access-Control-Allow-Headers: *'));
